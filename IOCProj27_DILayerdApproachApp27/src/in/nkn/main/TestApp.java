...
import in.nkn.controller.IEmployeeController;
...
public class TestApp{
	...
	public static void main(String[] args) {
		ClassPathXmlApplicationContext factory = new 
				ClassPathXmlApplicationContext("in/nkn/cfg/applicationContext.xml");
		...
		try {
			while(true) {
				...
				switch(choice) {
				   ...
				   case 2:
					   break;
				   case 3: employees = controller.findAllEmployees();
